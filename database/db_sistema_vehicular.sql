...
INSERT INTO solicitudes (id_usuario, id_area, fecha_solicitud, fecha_servicio, hora_servicio, direccion, cantidad_personas, motivo, observaciones, estado) VALUES
(6, 2, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), '09:00:00', 'Av. Salaverry 655, Jesús María', 3, 'Entrega de expedientes laborales', 'Documentación para mesa de partes', 'pendiente'),
(8, 6, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), '11:30:00', 'SUNAT - Av. Garcilaso de la Vega 1472, Lima', 4, 'Presentación de documentación tributaria', 'Debe retornar con cargo firmado', 'pendiente'),
(3, 4, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), '08:30:00', 'Gobierno Regional - Av. Arequipa 810, Lima', 5, 'Reunión de coordinación tecnológica', 'Equipo de TI con material de presentación', 'programada'),
(7, 3, CURDATE(), CURDATE(), '10:00:00', 'Almacén central - Av. Argentina 3020, Callao', 2, 'Supervisión de recepción de suministros', 'Ruta activa durante la mañana', 'programada'),
(3, 4, DATE_SUB(CURDATE(), INTERVAL 1 DAY), DATE_SUB(CURDATE(), INTERVAL 1 DAY), '09:15:00', 'Centro de datos externo - San Isidro', 2, 'Verificación de conectividad institucional', 'Atención cerrada sin incidencias', 'atendida'),
(9, 5, DATE_SUB(CURDATE(), INTERVAL 2 DAY), DATE_SUB(CURDATE(), INTERVAL 2 DAY), '15:30:00', 'Notaría Fernández - Jr. Lampa 879, Lima', 3, 'Legalización de documentos administrativos', 'Se entregaron documentos originales', 'atendida'),
(6, 2, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 1 DAY), '14:00:00', 'Centro de convenciones de Lima', 12, 'Traslado a capacitación externa', 'Solicitud rechazada por falta de unidad de alta capacidad en ese horario', 'rechazada'),
(8, 6, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 2 DAY), '16:00:00', 'Banco de la Nación - agencia San Borja', 2, 'Depósito de garantías institucionales', 'Cancelada por el área solicitante', 'cancelada');
